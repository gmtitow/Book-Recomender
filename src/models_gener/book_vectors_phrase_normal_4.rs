...
impl ModelInfo for BookVectorsPhraseNormal4 {
    fn get_table_name(&self) -> &str{
        "book_vectors_phrase_normal_4"
    }

    fn get_source() -> String {
        "book_vectors_phrase_normal_4".to_owned()
    }
