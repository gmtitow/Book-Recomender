...
#[derive(Default)]
pub struct BookVectorsTerm6Normal {
    pub book_id: IntCol,
...
impl ModelInfo for BookVectorsTerm6Normal {
    fn get_table_name(&self) -> &str{
        "book_vectors_term_6_normal"
    }

    fn get_source() -> String {
        "book_vectors_term_6_normal".to_owned()
    }
