...
#[derive(Default)]
pub struct BookVectorsPhraseNormal3 {
    pub book_id: IntCol,
...
impl ModelInfo for BookVectorsPhraseNormal3 {
    fn get_table_name(&self) -> &str{
        "book_vectors_phrase_normal_3"
    }

    fn get_source() -> String {
        "book_vectors_phrase_normal_3".to_owned()
    }
