...
impl ModelInfo for BookVectorsTerm5Normal {
    fn get_table_name(&self) -> &str{
        "book_vectors_term_5_normal"
    }

    fn get_source() -> String {
        "book_vectors_term_5_normal".to_owned()
    }
