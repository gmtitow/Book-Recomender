...
impl ModelInfo for BookVectorsTerm2Normal {
    fn get_table_name(&self) -> &str{
        "book_vectors_term_2_normal"
    }

    fn get_source() -> String {
        "book_vectors_term_2_normal".to_owned()
    }
