...
#[derive(Default)]
pub struct BookVectorsTerm4Normal {
    pub book_id: IntCol,
...
impl ModelInfo for BookVectorsTerm4Normal {
    fn get_table_name(&self) -> &str{
        "book_vectors_term_4_normal"
    }

    fn get_source() -> String {
        "book_vectors_term_4_normal".to_owned()
    }
