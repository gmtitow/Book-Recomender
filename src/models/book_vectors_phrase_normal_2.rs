...
#[derive(Default)]
pub struct BookVectorsPhraseNormal2 {
    pub book_id: IntCol,
...
impl BookVectorsModel for BookVectorsPhraseNormal2 {
    ...
    fn set_book_id(&mut self, book_id : ColEnum<i32>)->&Self{
        self.book_id = IntCol::new_col(book_id);
        self
    }

    fn set_vector_direct(&mut self, vector_direct : ColEnum<String>)->&Self{
        self.vector_direct = StringCol::new_col(vector_direct);
        self
    }


    fn set_vector_hashed(&mut self, vector_hashed : ColEnum<String>)->&Self{
        self.vector_hashed = StringCol::new_col(vector_hashed);
        self
    }

    fn set_vector_invers(&mut self, vector_invers : ColEnum<String>)->&Self{
...
impl BookVectorsPhraseNormal2 {

}

impl ModelInfo for BookVectorsPhraseNormal2 {
    fn get_table_name(&self) -> &str{
        "book_vectors_phrase_normal_2"
    }

    fn get_source() -> String {
        "book_vectors_phrase_normal_2".to_owned()
    }
