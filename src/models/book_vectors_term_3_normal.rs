...
#[derive(Default)]
pub struct BookVectorsTerm3Normal {
    pub book_id: IntCol,
...
impl ModelInfo for BookVectorsTerm3Normal {
    fn get_table_name(&self) -> &str{
        "book_vectors_term_3_normal"
    }

    fn get_source() -> String {
        "book_vectors_term_3_normal".to_owned()
    }
